{
    ...
    class Slideshow {
        ...
        init() {
            this.DOM.slides = Array.from(this.DOM.el.querySelectorAll('.slides--images > .slide1'));
            this.slidesTotal = this.DOM.slides.length;
            this.DOM.nav = this.DOM.el.querySelector('.slidenav1');
            this.DOM.titles = this.DOM.el.querySelector('.slides--titles');
            this.DOM.titlesSlides = Array.from(this.DOM.titles.querySelectorAll('.slide1'));
        ...
        createFrame() {
            ...
            <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                ...
                <stop offset="50%" stop-color="#3399cc"/>
